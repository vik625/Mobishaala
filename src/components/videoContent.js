        ...
        return (
            ...
            <div id='videoContent'>
                <div className = "container" style = {{paddingTop: 30}}>
                    ...
                    <div id = 'part1' className = 'row' style = {{textAlign: 'center'}}>
                        <div className = 'col-lg-6 col-md-12 col-sm-12 col-12' style = {{paddingTop: 30}}>
                        ...
                        <div className = 'col-lg-6 col-md-12 col-sm-12 col-12' style = {{marginTop: 20}}>
                            <iframe
                                className='shadow-lg'
                                style={{borderRadius:15, width: '100%', height: 300}} 
                    ...
                    <div id = 'part2' className = 'row' style = {{textAlign: 'center', display: 'none'}}>
                        <div className = 'col-lg-6 col-md-12 col-sm-12 col-12' style = {{paddingTop: 30}}>
                    ...
                    <div id = 'part3' className = 'row' style = {{textAlign: 'center', display: 'none'}}>
                        <div className = 'col-lg-6 col-md-12 col-sm-12 col-12' style = {{paddingTop: 30}}>
